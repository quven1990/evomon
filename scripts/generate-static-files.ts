...
writeFileSync(join(publicDir, "my_sitemap.xml"), sitemapXml, "utf8");
...
writeFileSync(
  ...
  `User-Agent: *\nAllow: /\n\nSitemap: ${SITE.url}/my_sitemap.xml\n\n# LLM / AI discovery\n# ${SITE.url}/llms.txt\n# ${SITE.url}/llms-full.txt\n`,
  "utf8",
);
writeFileSync(join(publicDir, `${INDEXNOW_KEY}.txt`), `${INDEXNOW_KEY}\n`, "utf8");

console.log(
  "Generated public/my_sitemap.xml, main_sitemap.xml, llms.txt, llms-full.txt, robots.txt, IndexNow key file",
);
