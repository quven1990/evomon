...
export const mapZones: MapZone[] = [
  ...
  },
  {
    ...
    spawns: [
      ...
      { name: "Glacone", level: "65–75", role: "wild" },
  ...
  },
  {
    ...
    spawns: [
      { name: "Tinkog", level: "90–105", role: "wild" },
      { name: "Tinkore", level: "101–105", role: "wild" },
      { name: "Humding", level: "96–105", role: "wild" },
      { name: "Flutterby", level: "96–105", role: "wild" },
  ...
  },
  {
    ...
    spawns: [
      ...
      { name: "Mirefish", level: "105–120", role: "wild" },
      { name: "Frostlet", level: "110–120", role: "wild" },
      { name: "Frostseer", level: "110–120", role: "wild" },
  ...
  },
  {
    ...
    zone: 11,
    levelRange: "115–120",
    huntTip: "Fighting island — Pummpaw into Pummash. Confirm extras in-game.",
    spawns: [
      { name: "Pummpaw", level: "115–120", role: "wild" },
      { name: "Pummash", level: "115–120", role: "wild" },
    ],
  },
  {
    id: "canyon-oasis",
    ...
    zone: 12,
    levelRange: "120–135",
    huntTip: "Bug line island — Gempillar / Chitmite into Chitaladin boss.",
    related: [
      { href: "/traits", label: "Traits (Leech line)" },
      { href: "/tier-list", label: "Tier list" },
    ],
    spawns: [
      { name: "Gempillar", level: "120–135", role: "wild" },
      { name: "Gempress", level: "120–135", role: "wild" },
      { name: "Chitmite", level: "126–135", role: "wild" },
      { name: "Chitgladi", level: "126–135", role: "wild" },
  ...
  },
  {
    ...
    spawns: [
      { name: "Vipip", level: "135–150", role: "wild" },
      { name: "Vipour", level: "135–150", role: "wild" },
      { name: "Tarro", level: "140–150", role: "wild" },
      { name: "Tarragon", level: "140–150", role: "wild" },
  ...
  },
  {
    ...
    spawns: [
      { name: "Starloop", level: "150–155", role: "wild" },
      { name: "Starmuse", level: "150–155", role: "wild" },
  ...
  },
  {
    ...
    spawns: [
      ...
      { name: "Fluffastar", level: "172–177", role: "wild" },
      { name: "Spikub", level: "170–180", role: "wild" },
      { name: "Spikumane", level: "170–180", role: "wild" },
